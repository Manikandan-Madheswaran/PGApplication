...
@RestController
public class MOFAbsherController
{
	...
	@RequestMapping(value = "/MOFAbsher")
	...
	@RequestMapping(value = "/MOFAbsherTransaction")
	...
	@RequestMapping(value = "/MOFAbsherResponse")
