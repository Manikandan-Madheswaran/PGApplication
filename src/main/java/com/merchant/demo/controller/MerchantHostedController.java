...
@RestController
public class MerchantHostedController
{
	@Autowired
	...
	@RequestMapping(value = "/MerchantHosted")
	public ModelAndView MerchantHosted(HttpServletRequest request,HttpServletResponse response)
	{
		...
		try
		{
			...
			mav.setViewName("MerchantHosted");
		}
		catch (Exception e)
		{
			e.printStackTrace();
	...
	@RequestMapping(value = "/MerchantHostedTransaction")
	...
	@RequestMapping(value = "/MerchantHostedResponse")
