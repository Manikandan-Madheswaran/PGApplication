...
@RestController
public class MerchantHostedPayoutController
{
	@Autowired
	...
	@RequestMapping(value = "/MerchantHostedPayout")
	public ModelAndView MerchantHosted(HttpServletRequest request,HttpServletResponse response)
	{
		...
		try
		{
			...
			mav.setViewName("MerchantHostedPayout");
		}
		catch (Exception e)
		{
			e.printStackTrace();
	...
	@RequestMapping(value = "/MerchantHostedPayoutTransaction")
	public ModelAndView performMerchantHostedTransaction(HttpServletRequest request,HttpServletResponse response,TransactionRequest tranData)
	{
		...
		try
		{
			...
			tranData.setResponseURL(ConfigFileUtil.getProperty("CONTEXT_PATH")+"MerchantHostedPayoutResponse");
			tranData.setErrorURL(ConfigFileUtil.getProperty("CONTEXT_PATH")+"MerchantHostedPayoutResponse");
	...
	@RequestMapping(value = "/MerchantHostedPayoutResponse")
