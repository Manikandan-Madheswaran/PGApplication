...
@RestController
public class MerchantHostedURPayController
{
	@Autowired
	...
	@RequestMapping(value = "/MerchantHostedURPayment")
	public ModelAndView MerchantHosted(HttpServletRequest request,HttpServletResponse response)
	{
		...
		try
		{
			...
			mav.setViewName("MerchantHostedURPayment");
		}
		catch (Exception e)
		{
			e.printStackTrace();
	...
	@RequestMapping(value = "/MerchantHostedURPaymentTransaction")
	public ModelAndView performMerchantHostedTransaction(HttpServletRequest request,HttpServletResponse response,TransactionRequest tranData)
	{
		...
		try
		{
			...
			tranData.setResponseURL(ConfigFileUtil.getProperty("CONTEXT_PATH")+"MerchantHostedURPaymentResponse");
			tranData.setErrorURL(ConfigFileUtil.getProperty("CONTEXT_PATH")+"MerchantHostedURPaymentResponse");
	...
	@RequestMapping(value = "/MerchantHostedURPaymentResponse")
